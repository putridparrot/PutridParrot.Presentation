...
public static class ViewModelExtensions
{
    ...
    public static void RaiseMultiplePropertyChanged<TObj>(this TObj o, Expression<Func<TObj, object>> propertyExpression, params Expression<Func<TObj, object>>[] morePropertyExpression)
        where TObj : IViewModel
    {
    ...
    public static void RaisePropertyChanged<TObj, TRet>(this TObj o, Expression<Func<TObj, TRet>> propertyExpression) where
        TObj : IViewModel
    {
    ...
    private static bool RaiseAndSetIfChanged<TObj, TRet>(this TObj o, Func<string> getPropertyName, ref TRet backingField, TRet newValue, Action validation = null) where
        TObj : IViewModel
    {
