...
namespace Tests.Presentation
{
    ...
    public class ViewModelTests
    {
        ...
        {
            var vm = new MyViewModel {IsEnabled = true};
        ...
        {
            var vm = new MyViewModel { IsEnabled = false };
        ...
        {
            var vm = new MyViewModel { Count = 0 };
        ...
        //{
        //    var vm = new MyViewModel { Count = 10 };
        ...
        {
            var vm = new MyViewModel {IsBusy = true};
        ...
        {
            var vm = new MyViewModel { NotTracked = true };
        ...
        {
            var vm = new MyViewModel {CannotBeNegative = -100};
        ...
        {
            var vm = new MyViewModel {Message = "Scooby Doo"};
